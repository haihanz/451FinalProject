...
<div class="jumbotron min-vh-100">
    <form method="POST" action="owner3.php">
        <input type="text" name="petID" class = "un" placeholder="Pet Number eg.1-15" align="center"> 
        <br>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
      ...
      $query = "SELECT petowner.fname, petowner.lname,pet.pet_name
      FROM petowner, pet
      WHERE petowner.owner_number = pet.owner_number
      AND pet.pet_number = ";
